...
namespace EatWise.Harvester.Infrastructure.Inbox;
    ...
    where TIntegrationEvent : IIntegrationEvent
{
        ...
        InboxMessageConsumer inboxMessageConsumer)
    {
        const string sql =
            ...
            SELECT EXISTS(
                SELECT 1
                FROM harvesters.inbox_message_consumers
        ...
        InboxMessageConsumer inboxMessageConsumer)
    {
        const string sql =
            """
            INSERT INTO harvesters.inbox_message_consumers(inbox_message_id, name)
